...
export const PawBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 opacity-[0.08] dark:opacity-[0.12]">
      {paws.map((paw) => (
        <div
          key={paw.id}
          ...
          style={{ 
            ...
            animationDelay: `${paw.id * 1.5}s`,
            animationDuration: `${15 + paw.id * 2}s`
          }}
        >
          <svg width="80" height="80" viewBox="0 0 48.839 48.839" fill="currentColor">
