...
export const GroomingGallery = () => {
  const animals = [
    { label: "Pudel Królewski", before: "/emotional-vet/grooming/poodle_before.png", after: "/emotional-vet/grooming/poodle_after.png" },
    { label: "Yorkshire Terrier", before: "/emotional-vet/grooming/yorkie_before.png", after: "/emotional-vet/grooming/yorkie_after.png" },
    { label: "Kot Perski", before: "/emotional-vet/grooming/cat_before.png", after: "/emotional-vet/grooming/cat_after.png" },
    { label: "Sznaucer Olbrzym", before: "/emotional-vet/grooming/schnauzer_before.png", after: "/emotional-vet/grooming/schnauzer_after.png" },
  ];
