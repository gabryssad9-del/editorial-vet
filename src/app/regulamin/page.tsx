  ...
  return (
    <main className="min-h-screen bg-background font-inter selection:bg-accent selection:text-white pb-20 md:pb-32 relative">
      ...
      <section className="px-4 md:px-8">
        <div className="container mx-auto max-w-4xl bg-card-bg rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-32 shadow-premium border border-border/50">
          <div className="prose prose-lg md:prose-xl prose-slate max-w-none space-y-12 md:space-y-16">
            <div className="space-y-6 md:space-y-8">
              <h2 className="text-2xl md:text-4xl font-black tracking-tight">1. Postanowienia Ogólne</h2>
              <p className="text-sm md:text-base text-text-gray leading-relaxed font-medium">
                Niniejszy regulamin określa zasady świadczenia usług weterynaryjnych przez Klinikę VETMED oraz zasady korzystania z systemu rezerwacji wizyt.
              </p>
            </div>

            <div className="space-y-6 md:space-y-8">
              <h2 className="text-2xl md:text-4xl font-black tracking-tight">2. Świadczenie Usług</h2>
              <p className="text-sm md:text-base text-text-gray leading-relaxed font-medium">
                Wszystkie usługi medyczne świadczone są przez wykwalifikowany personel lekarski zgodnie z aktualną wiedzą medyczną i etyką zawodu weterynarza.
              </p>
            </div>

            <div className="space-y-6 md:space-y-8">
              <h2 className="text-2xl md:text-4xl font-black tracking-tight">3. Rezerwacje i Wizyty</h2>
              <ul className="space-y-4 md:space-y-6 list-none pl-0 text-sm md:text-base">
                {[
                  'Wizyty należy umawiać telefonicznie lub przez formularz na stronie.',
                  'W przypadku rezygnacji prosimy o kontakt minimum 24h wcześniej.',
                  'Nagłe przypadki przyjmowane są priorytetowo poza kolejnością.'
                ].map((item, i) => (
            ...
            <div className="space-y-6 md:space-y-8 pt-12 md:pt-16 border-t border-border/50">
              <h2 className="text-2xl md:text-4xl font-black tracking-tight">4. Płatności</h2>
              <p className="text-sm md:text-base text-text-gray leading-relaxed font-medium">
                Płatność za usługi odbywa się po zakończeniu wizyty. Akceptujemy płatności gotówką, kartą oraz systemem BLIK. Cennik standardowych usług dostępny jest w recepcji kliniki.
              </p>
            </div>
          </div>
        </div>
