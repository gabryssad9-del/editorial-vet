...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://gabryssad9-del.github.io/editorial-vet/emotional-vet/hero-emotional.jpg",
        width: 1200,
        height: 630,
        alt: "VETMED Olsztyn",
      },
  ...
  twitter: {
    ...
    images: ["https://gabryssad9-del.github.io/editorial-vet/emotional-vet/hero-emotional.jpg"],
  },
  alternates: {
