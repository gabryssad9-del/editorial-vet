...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://gabryssad9-del.github.io/editorial-vet/emotional-vet/og-image.png?v=8",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://gabryssad9-del.github.io/editorial-vet/emotional-vet/og-image.png?v=8"],
  },
  alternates: {
